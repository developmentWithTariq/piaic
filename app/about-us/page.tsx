...
const testimonials: TestimonialAttributes[] = [
  {
    name: "Dr. Arif Alvi",
    position: "President of Islamic Republic of Pakistan",
    image: "/arif.png",
    content:
    [
...
const Testimonials = () => {
  return (
    <Container maxW="100vw" p={{ base: 5, md: 10 }} pt='90px'>
      {testimonials.map((obj, index) => (
        <Fragment key={index}>
          <VStack spacing={3} pt={1} justify="center">
            ...
            <VStack textAlign="justify" maxW="70vw">
                {obj?.content?.map((p) => (
                        <Text fontSize="lg" fontWeight="sm">
                            {p.para}
                        </Text>
                ))}
            </VStack>
